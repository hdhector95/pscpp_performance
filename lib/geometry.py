...
def calcChiDihedrals(atom1, atom2, atom3, atom4,cutoff=6.5):  #atom1, atom2, atom3, atom4

    # Set CA coordinates to origin
    A = [atom1[i] - atom3[i] for i in range(3)]
    B = [atom2[i] - atom3[i] for i in range(3)]
    C = [atom4[i] - atom3[i] for i in range(3)]
